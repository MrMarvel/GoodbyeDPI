...
* For other countries: Download [latest version from Releases page](https://github.com/ValdikSS/GoodbyeDPIssssss/releases), unpack the file and run **2_any_country_dnsredir.cmd**.
